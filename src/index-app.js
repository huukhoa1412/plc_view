...
(function(){
  ...
  function buildCard(p){
    ...
    card.innerHTML =
		...
		'<button class="more" data-more-for="'+p.id+'" style="display:none">Xem thêm</button>'+
		'<div class="actions">'+
		  '<a class="link" data-open-id="'+p.id+'" href="#">Mở</a>'+
		  '<button class="kebab" aria-haspopup="true" aria-expanded="false" data-id="'+p.id+'">•••</button>'+
		  '<div class="menu" role="menu" data-menu-for="'+p.id+'">'+
			'<button class="menu-item" data-act="rename"     data-id="'+p.id+'">✏<span>Đổi tên</span></button>'+
			'<button class="menu-item" data-act="editdesc"   data-id="'+p.id+'">📝<span>Chỉnh sửa mô tả</span></button>'+
			'<button class="menu-item" data-act="replace"    data-id="'+p.id+'">📂<span>Thay thế tệp JSON</span></button>'+
			'<button class="menu-item" data-act="duplicate"  data-id="'+p.id+'">⧉<span>Nhân bản</span></button>'+
			'<button class="menu-item" data-act="exportOne"  data-id="'+p.id+'">💾<span>Xuất dự án</span></button>'+
			'<button class="menu-item" data-act="copylink"   data-id="'+p.id+'">🔗<span>Sao chép liên kết</span></button>'+
			'<hr/>'+
			'<button class="menu-item danger" data-act="delete" data-id="'+p.id+'">🗑<span>Xóa</span></button>'+
		  '</div>'+
		'</div>';
  ...
  (function(){
    function applyLang(lang){
      ...
      document.getElementById('btnVI').classList.toggle('is-active', lang === 'vi');
    ...
    window.addEventListener('DOMContentLoaded', function(){
      ...
      document.getElementById('btnVI').addEventListener('click', () => applyLang('vi'));
